...
export default function UserFollowersPage({ data }) {
    ...
    <>
      ...
      <MainGrid theme={theme}>
        ...
        <div className="welcomeArea">
          <Box>
            <h1 className="title subPageTitle">Seguidores</h1>
            <p className="pathSubtitle">
              Início &#62; {data.userInfo.name} &#62; <span>Seguidores</span>
            </p>
            <hr />
            {followers.length < 1 ? (
              <span className="noScrap">Você ainda não possui seguidores!</span>
            ) : (
              <ul>
